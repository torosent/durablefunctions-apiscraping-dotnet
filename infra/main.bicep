...
// Note: storage-PrivateEndpoint.bicep is intentionally not included in this sample.
// If you need VNet support with private endpoints, add the module under ./app and
